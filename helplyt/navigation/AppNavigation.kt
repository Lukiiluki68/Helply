...
sealed class Screen(val route: String) {
    ...
    object UserProfileOpinion : Screen("profileopinion")
    object Profile : Screen("profile")
    object ChangePassword : Screen("changePassword")
    object ChangeAddress : Screen("changeAddress")
   // object MyOpinion : Screen("myopinion")
    object SetupProfile : Screen("setupProfile")
    object MyAdvertisements : Screen("myAdvertisements")
    object AddOpinion : Screen("addOpinion/{userId}") {
        fun createRoute(userId: String) = "addOpinion/$userId"
    }
    object MyOpinion : Screen("myopinion/{userId}") {
        fun createRoute(userId: String) = "myopinion/$userId"
    }
...
fun AppNavigation(
    ...
    myAdvertisementViewModel: MyAdvertisementViewModel
) {
